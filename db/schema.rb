...
ActiveRecord::Schema.define(version: 2020_10_05_193549) do
  ...
  create_table "transactions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["virtual_card_id"], name: "index_transactions_on_virtual_card_id"
  end
  ...
  add_foreign_key "transactions", "virtual_cards"
end
